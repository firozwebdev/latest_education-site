            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner text-center">
                        ...
                        <h1 class="title display-one text-white">WE KEEP THINGS SIMPLE, PUTTING YOU
                            <br>IN CONTROL SO YOU CAN MAKE INFORMED CHOICES
                        </h1>
                        <div class="read-more-btn mt--40">
                            <a class="rbt-btn btn-gradient hover-icon-reverse" href="{{ route('contact') }}">
                                <span class="icon-reverse-wrapper">
                                    <span class="btn-text">WE’RE HERE TO HELP </span>
                                    <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                                    <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                                </span>
                            </a>
                    ...
                    <div class="thumbnail-wrapper">
                        <div class="thumbnail image-1">
                            <img data-parallax="{&quot;x&quot;: 0, &quot;y&quot;: -20}"
                                ...
                                style="transform:translate3d(0px, -6.14px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(0px, -6.14px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); ">
                        </div>
                        <div class="thumbnail image-2 d-none d-xl-block">
                            <img data-parallax="{&quot;x&quot;: 0, &quot;y&quot;: 60}"
                                src="{{ asset('assets/images/about/about-02.jpg') }}" alt="Education Images"
                                style="transform:translate3d(0px, 15.91px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(0px, 15.91px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); ">
                        </div>
                        <div class="thumbnail image-3 d-none d-md-block">
                            <img data-parallax="{&quot;x&quot;: 0, &quot;y&quot;: 60}"
                                src="{{ asset('assets/images/about/about-03.jpg') }}" alt="Education Images"
                                style="transform:translate3d(0px, 15.91px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(0px, 15.91px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); ">
                ...
                <div class="col-lg-6">
                    <div class="inner pl--50 pl_sm--0 pl_md--0">
                        <div class="section-title text-start">
                            <span class="subtitle bg-coral-opacity">KNOW ABOUT KMF</span>
                            <h2 class="title">KNOW ABOUT KMF <br> VISA CONSULTANCY PLATFORM</h2>
                        </div>

                        <p class="description mt--30">KMF Global Education Ltd transforms students dream to study abroad. It
                            is specialized in providing the guidance to the students to find the right universities and the
                            right courses. KMF Global Education ltd empowers the students to unlock their potentials and
                            achieve their academic excellence. </p>
                        ...
                        <div class="rbt-feature-wrapper mt--20 ml_dec_20">
                            <div class="rbt-feature feature-style-2 rbt-radius">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p class="feature-description">We strive to provide personalized, reliable, and ethical
                                        educational consultancy services, helping students navigate the path to studying
                                        abroad with confidence and clarity. Our goal is to connect students with the right
                                        institutions and opportunities that align with their ambitions and values.</p>
                                </div>
                            </div>
                            ...
                            <div class="rbt-feature feature-style-2 rbt-radius">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p class="feature-description">Personalized, reliable and holistic services turn the
                                        student to navigate the right universities and courses with affordable costs. Having
                                        a vast network of partner universities, we are providing our services. From choosing
                                        the right university to securing your visa and accommodation, we are here to guide
                        ...
                        <div class="about-btn mt--40">
                            <a class="rbt-btn btn-gradient hover-icon-reverse" href="{{ route('book-appointment') }}">
                                <span class="icon-reverse-wrapper">
                                    <span class="btn-text">BOOK CONSULTANT</span>
                                    <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                                    <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                                </span>
                            </a>
            ...
            <div class="row g-5">
                <div class="col-lg-12 mb--60">
                    <div class="section-title text-center">
                        <span class="subtitle bg-pink-opacity">OUR EXPERT TEAM</span>
                        <h2 class="title">GET IN TOUCH WITH OUR EXPERT TEAM</h2>
                        <p class="description mt--20">KMF Global Education Ltd empowers students worldwide with expert visa guidance, admissions support, and career counseling for global academic success.</p>
                    </div>
                </div>
            </div>
