                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class=" title-wrapper">
                                <h1 class="title mb--0">Popular Subjects</h1>
                                <a href="#" class="rbt-badge-2">
                                    <div class="image">🎉</div> {{ $subjects->total() }} Subjects
                                </a>
                            </div>
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="rbt-sorting-list d-flex flex-wrap align-items-center">
                                ...
                                <div class="rbt-short-item">
                                    <span class="course-index">Showing {{ $subjects->firstItem() }}-{{ $subjects->lastItem() }} of {{ $subjects->total() }} results</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="course-grid-3">
                        <div class="rbt-card variation-01 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="#">
                                    <img src="{{ asset($subject->image ?? 'assets/images/course/course-online-01.jpg') }}" alt="Subject image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                                <div class="rbt-card-top">
                                    <div class="rbt-review">
                                        ...
                                        <span class="rating-count"> (Popular)</span>
                                    </div>
                                ...
                                <h4 class="rbt-card-title"><a href="#">{{ $subject->name }}</a>
                                </h4>

                                <ul class="rbt-meta">
                                    <li><i class="feather-book"></i>Subject</li>
                                    <li><i class="feather-users"></i>Multiple Courses</li>
                                </ul>

                                <p class="rbt-card-text">{{ Str::limit(strip_tags($subject->description) ?? 'No description available.', 100) }}</p>
                                <div class="rbt-author-meta mb--10">
                                    <div class="rbt-avater">
                                        <a href="#">
                                            <img src="{{ asset('assets/images/client/avatar-02.png') }}" alt="Subject">
                                        </a>
                                    </div>
                                    <div class="rbt-author-info">
                                        Popular <a href="#">Subject</a>
                                    </div>
                                </div>
                                <div class="rbt-card-bottom">
                                    <div class="rbt-price">
                                        <span class="current-price">Explore</span>
                                    </div>
