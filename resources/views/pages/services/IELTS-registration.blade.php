...
<!--                            <h4 class="title">TAILORED CAREER GUIDANCE FOR A SUCCESSFUL FUTURE <strong-->
<!--                                    class="color-primary">A SUCCESSFUL FUTURE</strong></h4>-->
<!--                        </div>-->
<!--                        <p align="justify">Planning a successful career can feel overwhelming, especially with countless-->
<!--                            options and evolving industries. At KMF GLOBAL EDUCATION LTD , our expert Career Counseling-->
<!--                            services help you make informed decisions about your future. From exploring career paths to-->
<!--                            developing a solid plan, we provide guidance tailored to your unique strengths, interests, and-->
<!--                            goals.-->

<!--                            Whether you are a high school student, recent graduate, or professional looking for a career-->
<!--                            shift, our counselors provide personalized advice and actionable strategies to help you navigate-->
<!--                            your journey with confidence.-->

<!--                            Our approach is comprehensive, covering everything from understanding your aspirations to-->
<!--                            building the skills and confidence needed to achieve them. With us by your side, you’re set for-->
<!--                            a brighter, more fulfilling future.</p>-->
...
<!--                                        <div class="thumbnail">-->
<!--                                            <a href="#">-->
<!--                                                <img src="http://localhost:8000/assets/images/testimonial/icon-02.png"-->
<!--                                                    alt="Author Images">-->
<!--                                            </a>-->
<!--                                        </div>-->
...
<!--                                            <div class="content">-->
<!--                                                <p class="description">-->
<!--                                                    We begin with a detailed career assessment to understand your interests,-->
<!--                                                    abilities, and personality traits. Using professional tools and-->
<!--                                                    techniques, we evaluate your strengths and potential career paths. This-->
<!--                                                    helps us identify the best opportunities tailored to your skills and-->
<!--                                                    aspirations.-->

<!--                                                    Our counselors offer personalized feedback and recommend industries or-->
<!--                                                    fields that align with your goals, making it easier for you to focus on-->
<!--                                                    the right path.-->
<!--                                                </p>-->
<!--                                            </div>-->
<!--                                        </div>-->
...
<!--                                        <div class="thumbnail">-->
<!--                                            <a href="#">-->
<!--                                                <img src="http://localhost:8000/assets/images/testimonial/studying.png"-->
<!--                                                    alt="Author Images">-->
<!--                                            </a>-->
<!--                                        </div>-->
<!--                                        <div class="media-body">-->
<!--                                            <div class="author-info">-->
<!--                                                <h5 class="title">-->
<!--                                                    <a class="hover-flip-item-wrapper" href="#">GOAL SETTING AND-->
<!--                                                        PLANNING</a>-->
<!--                                                </h5>-->
<!--                                            </div>-->
<!--                                            <div class="content">-->
<!--                                                <p class="description">-->
<!--                                                    Setting realistic and achievable goals is essential for career success.-->
<!--                                                    We work with you to define clear, step-by-step plans that bridge the gap-->
<!--                                                    between where you are now and where you want to be. This includes-->
<!--                                                    academic planning, skill development, and professional milestones.-->

<!--                                                    Our counselors help you map out your journey with practical strategies,-->
<!--                                                    ensuring that every step is aligned with your aspirations.-->
...
<!--                                        <div class="thumbnail">-->
<!--                                            <a href="#">-->
<!--                                                <img src="http://localhost:8000/assets/images/testimonial/airdrop.png"-->
<!--                                                    alt="Author Images">-->
<!--                                            </a>-->
<!--                                        </div>-->
<!--                                        <div class="media-body">-->
<!--                                            <div class="author-info">-->
<!--                                                <h5 class="title">-->
<!--                                                    <a class="hover-flip-item-wrapper" href="#">INTERVIEW AND SKILL-->
<!--                                                        DEVELOPMENT</a>-->
<!--                                                </h5>-->
<!--                                            </div>-->
<!--                                            <div class="content">-->
<!--                                                <p class="description">-->
<!--                                                    Excelling in your career often requires strong communication and-->
<!--                                                    interpersonal skills. Our services include mock interviews, resume-->
<!--                                                    building, and skill enhancement sessions to help you stand out in a-->
<!--                                                    competitive job market.-->

<!--                                                    From building confidence to perfecting your professional etiquette, we-->
<!--                                                    ensure you’re fully prepared to make a lasting impression on employers-->
...
<!--                                            <div class="content">-->
<!--                                                <p class="description">-->
<!--                                                    At KMF GLOBAL EDUCATION LTD , our mission is to empower you to take-->
<!--                                                    charge of your future. Our comprehensive Career Counseling services are-->
<!--                                                    designed to support you every step of the way, ensuring that you have-->
<!--                                                    the guidance and resources needed to succeed in your chosen career path.-->

<!--                                                    Contact us today to learn more about how we can help you achieve your-->
<!--                                                    career goals. Let us be your trusted partner in building a brighter-->
<!--                                                    tomorrow!-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
...
<!--                                    href="{{ route('services.admission') }}">-->
<!--                                    <span class="btn-text">ASMISSION</span>-->
<!--                                    <span class="btn-icon"><i class="feather-arrow-right"></i></span>-->
<!--                                </a>-->
<!--                            </div>-->
<!--                            <div class="add-to-card-button mt--15">-->
<!--                                <a class="rbt-btn btn-gradient icon-hover w-100 d-block text-center"-->
<!--                                    href="{{ route('services.scholarship') }}">-->
...
<!--                            <div class="add-to-card-button mt--15">-->
<!--                                <a class="rbt-btn btn-gradient icon-hover w-100 d-block text-center"-->
<!--                                    href="{{ route('services.visa-guidance') }}">-->
...
<!--                            <div class="add-to-card-button mt--15">-->
<!--                                <a class="rbt-btn btn-gradient icon-hover w-100 d-block text-center"-->
<!--                                    href="{{ route('services.departure-guidance') }}">-->
...
<!--                            <div class="add-to-card-button mt--15">-->
<!--                                <a class="rbt-btn btn-gradient icon-hover w-100 d-block text-center"-->
<!--                                    href="{{ route('services.ielts-registration') }}">-->
...
<!--                            <div class="add-to-card-button mt--15">-->
<!--                                <a class="rbt-btn btn-gradient icon-hover w-100 d-block text-center"-->
<!--                                    href="{{ route('services.career-counsel') }}">-->
...
<!--                                                class="feather-phone mr--5"></i> Call Us: <a href="#"><strong>+880-->
<!--                                                    167 1135988-->
<!--                                                </strong></a></p>-->
<!--                                    </div>-->
<!--                                </div>-->
