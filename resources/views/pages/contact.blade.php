                ...
                error: function(xhr) {
                    ...
                    if (xhr.status === 422) {
                        ...
                        if (response && response.errors) {
                            ...
                            if (response.errors['contact-phone'] && response.errors['contact-phone'][0].includes('already been taken')) {
    ...
    <div class="popup-mobile-menu">
        <div class="inner-wrapper">
            <div class="inner-top">
                ...
                <p class="description">KMF Global Education is a Education Visa Consultancy website.</p>
                <ul class="navbar-top-left rbt-information-list justify-content-start">
                    <li>
                        <a href="mailto:hello@example.com"><i class="feather-mail"></i>info@kmfglobaleducation.com</a>
                    </li>
                    <li>
                        <a href="#"><i class="feather-phone"></i>+880 167 1135988</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center mb--60">
                        ...
                        <h2 class="title">KMF CONSULTANCY RELATED CONSULTANCY INQUARES. </h2>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-delay="150" data-sal-duration="800">
                    <div class="rbt-address">
                        ...
                        <div class="inner">
                            <h4 class="title">London Office, UK Branch</h4>
                            <p>44 Circus Road, London, NW8 9JH</p>
                            <p><a href="tel:+44 7956040045">+44 7956040045</a></p>
                            <p><a href="tel:+44 7885636441">+44 7885636441</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-delay="200" data-sal-duration="800">
                    <div class="rbt-address">
                        ...
                        <div class="inner">
                            <h4 class="title">Dhaka, BD Branch</h4>
                            <p># 4/1, Road #27 (New 16), Dhanmondi, Dhaka, Bangladesh</p>
                            <p><a href="tel:+8801671-135988">+8801671-135988</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-delay="250" data-sal-duration="800">
                    <div class="rbt-address">
                        ...
                        <div class="inner">
                            ...
                            <p> Dhanmondi Tower, House 4/1 3rd Floor <br> Road 27, Dhanmondi, Dhaka.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-delay="150" data-sal-duration="800">
                    <div class="rbt-address">
                        ...
                        <div class="inner">
                            ...
                            <p><a href="tel:+880 167 1135988">+880 167 1135988</a></p>
                            <p><a href="tel:+880 167 1135988">+880 167 1135988</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate" data-sal="slide-up" data-sal-delay="200" data-sal-duration="800">
                    <div class="rbt-address">
                        ...
                        <div class="inner">
                            ...
                            <p><a href="mailto:info@kmfglobaleducation.com">info@kmfglobaleducation.com</a></p>
                            <p><a href="mailto:info@kmfglobaleducation.com">info@kmfglobaleducation.com</a></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="rbt-contact-form contact-form-style-1 max-width-auto">
                        ...
                        <form id="contact-form" class="rainbow-dynamic-form max-width-auto">
                            ...
                            <div class="form-group">
                                <input name="contact-name" id="contact-name" type="text" value="{{ old('contact-name') }}">
                                <label>Name</label>
                                <span class="focus-border"></span>
                                <div class="text-danger"></div>
                            </div>
                            <div class="form-group">
                                <input name="contact-email" id="contact-email" type="email" value="{{ old('contact-email') }}">
                                <label>Email</label>
                                <span class="focus-border"></span>
                                <div class="text-danger"></div>
                            </div>
