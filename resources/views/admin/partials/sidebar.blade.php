...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="{{ route('admin.dashboard') }}" class="brand-link">
            <!--begin::Brand Image-->
            <img
              src="{{ asset('admin_assets/assets/img/AdminLTELogo.png')}}" 
              alt="AdminLTE Logo"
              class="brand-image opacity-75 shadow"
            />
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">KMF MANAGMENT</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="{{ route('admin.success-deliveries.index') }}" class="nav-link">
                  <i class="nav-icon bi bi-check-circle"></i>
                  <p>Success Deliveries</p>
                </a>
              </li>             
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('admin.assessments.index') }}" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Get Assessment Information</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ route('admin.appointments.index') }}" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Book Appointment Information</p>
                    </a>
                  </li>
                  <li class="nav-item">
