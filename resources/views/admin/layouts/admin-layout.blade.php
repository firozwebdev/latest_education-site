...
<html lang="en">
  ...
  <head>
    ...
    <title>KMF GLOBAL EDUCATION | MANAGMENT SYSTEM</title>
    ...
    <link rel="preload" href="{{ asset('admin_assets/css/adminlte.css') }}" as="style" />
    ...
    <div class="app-wrapper">
      ...
      <footer class="app-footer">
        ...
        <strong>
          ...
          <a href="#" class="text-decoration-none">Wide Dev Solution</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
