        ...
        <div class="inner-wrapper">
            <div class="inner-top">
                ...
                <ul class="navbar-top-left rbt-information-list justify-content-start">
                    <li>
                        <a href="mailto:info@kmfglobaleducation.com><i class="feather-mail"></i>info@kmfglobaleducation.com</a>
                    </li>
                    <li>
                        <a href="#"><i class="feather-phone"></i>+880 1671135988</a>
                    </li>
                </ul>
            </div>
            ...
            <nav class="mainmenu-nav">
                <ul class="mainmenu">
                    ...
                    <li class="with-megamenu has-menu-child-item position-static">
                        <a href="#">Future Career <i class="feather-chevron-down"></i></a>
                        <!-- Start Mega Menu  -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="inner text-start">
                        <h2 class="title">Make Your Abroad Study Dream Come True</h2>
                        <div class="slider-btn rbt-button-group justify-content-start">
                            ...
                            <a class="rbt-btn-link color-white" href="#">APPLAY ONLINE<i class="feather-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row row--15 mt_dec--30">
                ...
                <div class="col-lg-4 col-xl-4 col-md-6 col-sm-6 col-12 mt--30">
                    <div class="service-card service-card-6 bg-color bg-card-color-1">
                        <div class="inner">
                            <div class="icon">
                                <img src="http://localhost:8000/assets/images/shape/service-01.png" alt="Shape Images">
                                <img class="opacity_image" src="http://localhost:8000/assets/images/shape/service-01.png" alt="Shape Images">
                            </div>
                            <div class="content">
                                <h6 class="title"><a href="#">Admission</a></h6>
                ...
                <div class="col-lg-4 col-xl-4 col-md-6 col-sm-6 col-12 mt--30">
                    <div class="service-card service-card-6 bg-color bg-card-color-2">
                        <div class="inner">
                            <div class="icon">
                                <img src="http://localhost:8000/assets/images/shape/service-04.png" alt="Shape Images">
                                <img class="opacity_image" src="http://localhost:8000/assets/images/shape/service-04.png" alt="Shape Images">
                            </div>
                            <div class="content">
                                <h6 class="title"><a href="#">Scholarships</a></h6>
                ...
                <div class="col-lg-4 col-xl-4 col-xxl-4 col-md-6 col-sm-6 col-12 mt--30">
                    <div class="service-card service-card-6 bg-color bg-card-color-3">
                        <div class="inner">
                            <div class="icon">
                                <img src="http://localhost:8000/assets/images/shape/service-03.png" alt="Shape Images">
                                <img class="opacity_image" src="http://localhost:8000/assets/images/shape/service-03.png" alt="Shape Images">
                            </div>
                            <div class="content">
                                <h6 class="title"><a href="#">Visa Guidance</a></h6>
                ...
                <div class="col-lg-4 col-xl-4 col-xxl-4 col-md-6 col-sm-6 col-12 mt--30">
                    <div class="service-card service-card-6 bg-color bg-card-color-4">
                        <div class="inner">
                            <div class="icon">
                                <img src="http://localhost:8000/assets/images/shape/service-02.png" alt="Shape Images">
                                <img class="opacity_image" src="http://localhost:8000/assets/images/shape/service-02.png" alt="Shape Images">
                            </div>
                            <div class="content">
                                <h6 class="title"><a href="#">Departure Guidance</a></h6>
                ...
                <div class="col-lg-4 col-xl-4 col-xxl-4 col-md-6 col-sm-6 col-12 mt--30">
                    <div class="service-card service-card-6 bg-color bg-card-color-5">
                        <div class="inner">
                            <div class="icon">
                                <img src="http://localhost:8000/assets/images/shape/service-05.png" alt="Shape Images">
                                <img class="opacity_image" src="http://localhost:8000/assets/images/shape/service-05.png" alt="Shape Images">
                            </div>
                            <div class="content">
                                <h6 class="title"><a href="#">IELTS & Career</a></h6>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12">
                    <p class="rbt-link-hover text-center text-lg-start">Copyright © 2025 <a href="https://www.widedevsolution.com/">Wide Dev Solution</a> All Rights Reserved</p>
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12">
