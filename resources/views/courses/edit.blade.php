                    ...
                    <form action="{{ route('admin.courses.update', $course) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="study_level" class="form-control">
                                ...
                                <option value="Postgraduate" {{ $course->study_level == 'Postgraduate' ? 'selected' : '' }}>Postgraduate</option>
                                <option value="Diploma" {{ $course->study_level == 'Diploma' ? 'selected' : '' }}>Diploma</option>
                                <option value="Certificate" {{ $course->study_level == 'Certificate' ? 'selected' : '' }}>Certificate</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="duration">Duration</label>
                            <input type="text" name="duration" class="form-control" value="{{ $course->duration }}" placeholder="e.g., 3 years, 6 months, 12 weeks">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="course_type" class="form-control">
                                ...
                                <option value="hybrid" {{ $course->course_type == 'hybrid' ? 'selected' : '' }}>Hybrid</option>
                            </select>
                        </div>
                        <div class="form-group">
