            ...
            <div class="inner-top">
                <div class="content">
                    ...
                    <div class="rbt-btn-close">
                                        ...
                                        <div class="rbt-card variation-01 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="{{ route('courseDetails2', [$rc->slug ?? $rc->id]) }}">
                                                    <img src="{{ $rc->images ? asset($rc->images) : asset('assets/images/course/course-online-03.jpg') }}" alt="Card image">
                                            ...
                                            <div class="rbt-card-body">
                                                <div class="rbt-card-top">
                                                    <div class="rbt-review">
                                                        ...
                                                        <span class="rating-count"> ({{ rand(1,15) }} Reviews)</span>
                                                    </div>
                        ...
                        @else
                            <!-- fallback to static cards (kept original) -->
                            <div class="row g-5">
                                <!-- original static cards kept as fallback -->
                                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="rbt-card variation-01 rbt-hover">
                                        <div class="rbt-card-img">
                            ...
                            <div class="content text-center">
                                ...
                                <div class="d-flex align-items-center flex-wrap justify-content-center mb--15 rbt-course-details-feature">
                                    ...
                                    <div class="feature-sin rating">
                                        ...
                                        @for($i=0;$i<5;$i++)
                                            <a href="#"><i class="fa fa-star {{ $i < round((float)($course->rating ?? 0)) ? 'text-warning' : 'text-muted' }}"></i></a>
                                        @endfor
                                    </div>
                                ...
                                <div class="rbt-author-meta mb--20 justify-content-center">
                                    ...
                                    <div class="rbt-author-info">
                                        ...
                                        @if($course->university)
                                            In <a href="#">{{ $course->university->university_name }}</a>
                                        @endif
                                    </div>
                                </div>

                                <ul class="rbt-meta">
                                    <li><i class="feather-calendar"></i>Last updated {{ optional($course->updated_at)->format('m/Y') ?? '' }}</li>
                                    <li><i class="feather-globe"></i>{{ $course->language ?? 'English' }}</li>
                                    <li><i class="feather-award"></i>{{ $course->certificate ? 'Certified Course' : 'No Certificate' }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="content-item-content">
                                        ...
                                        <div class="rbt-widget-details has-show-more">
                                            <ul class="has-show-more-inner-content rbt-course-details-list-wrapper">
                                                <li><span>Start Date</span><span class="rbt-feature-value rbt-badge-5">{{ $course->next_intake ?? 'TBA' }}</span>
                                                </li>
                                                <li><span>Enrolled</span><span class="rbt-feature-value rbt-badge-5">{{ $course->enrolled }}</span></li>
                                                <li><span>Lectures</span><span class="rbt-feature-value rbt-badge-5">{{ $course->lectures }}</span></li>
                                                <li><span>Skill Level</span><span class="rbt-feature-value rbt-badge-5">{{ $course->student_level }}</span></li>
                                                <li><span>Language</span><span class="rbt-feature-value rbt-badge-5">{{ $course->language }}</span></li>
                                                <li><span>Quizzes</span><span class="rbt-feature-value rbt-badge-5">{{ $course->quizzes_count ?? 10 }}</span></li>
                                                <li><span>Certificate</span><span class="rbt-feature-value rbt-badge-5">{{ $course->certificate ? 'Yes' : 'No' }}</span></li>
                                                <li><span>Pass Percentage</span><span class="rbt-feature-value rbt-badge-5">{{ $course->pass_percentage ?? 0 }}%</span></li>
                                            </ul>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="course-details-content">
                                ...
                                <div class="rbt-course-feature-box overview-wrapper rbt-shadow-box mt--30 has-show-more" id="overview">
                                        ...
                                        <p>{{ Str::limit($course->description ?? 'No description available for this course yet.', 400) }}</p>
                                        ...
                                        <div class="media align-items-center">
                                            <div class="thumbnail">
                                                ...
                                                <div class="author-info">
                                                    <h5 class="title">
                                                        <a class="hover-flip-item-wrapper" href="#">{{ $course->instructor? $course->instructor->name : 'Instructor Name' }}</a>
                                                    </h5>
                                                    <span class="b3 subtitle">{{ $course->instructor? 'Instructor' : '' }}</span>
                                                    <ul class="rbt-meta mb--20 mt--10">
                                                        <li><i class="fa fa-star color-warning"></i>{{ number_format($course->rating,1) }} Reviews <span class="rbt-badge-5 ml--5">{{ $course->rating }}</span></li>
                                                        <li><i class="feather-users"></i>{{ $course->enrolled }} Students</li>
                                                        <li><a href="#"><i class="feather-video"></i>{{ $course->lectures }} Courses</a></li>
                                                    </ul>
                                                </div>
                                                <div class="content">
                                                    <p class="description">{{ Str::limit($course->description ?? 'John is a brilliant educator', 200) }}</p>
                                            ...
                                            @foreach($relatedCourses as $rc)
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                                    <div class="rbt-card variation-01 rbt-hover">
                                                        <div class="rbt-card-img">
                                                            <a href="{{ route('courseDetails2', [$rc->slug ?? $rc->id]) }}">
                                                                <img src="{{ $rc->images ? asset($rc->images) : asset('assets/images/course/course-online-01.jpg') }}" alt="Card image">
                                                                @if(!empty($rc->off_price) && !empty($rc->current_price))
                                                                    @php
                                                                        $offPrice = (float) ($rc->off_price ?? 0);
                                                                        $currentPrice = (float) ($rc->current_price ?? 0);
